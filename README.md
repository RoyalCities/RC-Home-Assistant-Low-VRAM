...
This stack includes [`openwakeword`](https://github.com/rhasspy/wyoming-openwakeword) to support **custom wake words**, using `.tflite` models trained or downloaded locally.
